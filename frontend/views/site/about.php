    ...
    <div class="container">
        ...
        <div class="row our_bakery_image">
            <div class="col-md-4 col-6">
                <img class="img-fluid" src="img/our-bakery/bakery-1.jpg?1" alt="Cake">
            </div>
            <div class="col-md-4 col-6">
                <img class="img-fluid" src="img/our-bakery/bakery-2.jpg?1" alt="Capcakes">
            </div>
            <div class="col-md-4 col-6">
                <img class="img-fluid" src="img/our-bakery/bakery-3.jpg?1" alt="Cake">
            </div>
        </div>
    </div>
</section>
